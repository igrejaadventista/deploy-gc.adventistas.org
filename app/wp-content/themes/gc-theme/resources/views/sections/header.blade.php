<header class="bg-transparent md:bg-black/20 h-36 md:h-[92px] px-3.5 md:px-9 flex items-center justify-between absolute w-full z-10">
  ...
  @if(has_nav_menu('primary_navigation'))
    ...
    <nav
      class="fixed md:relative top-0 left-full md:left-0 bottom-0 pt-36 md:pt-0 bg-secondary md:bg-transparent w-full md:w-auto transition-all flex justify-center"
