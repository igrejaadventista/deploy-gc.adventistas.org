...
>
  ...
  <template id="timeline-title">
    ...
    >
      <?php _e('Notícias de', 'gc') ?> <span class="timeline-title__day font-bold"><?php _e('hoje', 'gc') ?></span>
    </h2>
  </template>
  ...
  <template id="timeline-manual-site">
    <article class="mb-12 md:mb-14">
      <div class="border-l-8 border-secondary pl-4">
        <x-time class="text-right mt-4"><?php _e('às', 'lg') ?> <span class="timeline-item-time"></span></x-time>
        ...
        <div class="bg-[#F8F9FB] rounded-lg overflow-hidden">
          ...
          <div class="p-4 md:p-6">
            ...
            <a class="timeline-item-link btn-secondary py-2 px-3 text-sm mt-4 md:mt-6" href="#" rel="noopener" target="_blank">
              <span class="grow-1 shrink-0 basis-auto"><?php _e('Ler mais', 'gc') ?></span>
              <img class="ml-2 h-3" src="@asset('images/icons/arrow-down.svg')" alt="<?php _e('Seta para baixo', 'gc') ?>">
            </a>
          </div>
        </div>
      </div>
